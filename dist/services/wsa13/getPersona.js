...
class GetPersona {
    constructor(wsA13WSDL) {
        this.wsA13WSDL = wsA13WSDL;
    }
    getPersona(cuit, token, sign, documento) {
        return __awaiter(this, void 0, void 0, function* () {
            const soapClient = yield soap.createClientAsync(this.wsA13WSDL);
            const requestBody = {
                token: token,
                sign: sign,
            ...
            try {
                const response = yield soapClient.getPersonaAsync(requestBody);
