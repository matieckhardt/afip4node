...
exports.FECAEAConsultarService = void 0;
// services/wsfe/FECAEAConsultar.ts
const soap = __importStar(require("soap"));
class FECAEAConsultarService {
    constructor(wsfeWSDL) {
        this.wsfeWSDL = wsfeWSDL;
    }
    consultarCAEA(cuit, token, sign, PtoVta, Periodo, Orden) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield soapClient.FECAEAConsultarAsync(requestBody);
...
exports.FECAEAConsultarService = FECAEAConsultarService;
