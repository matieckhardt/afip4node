...
exports.FEParamGetTiposPaises = void 0;
    ...
    getTiposPaises(cuit, token, sign) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield soapClient.FEParamGetTiposPaisesAsync({
                    Auth: requestBody.Auth,
                });
                // Analizar y devolver la respuesta
                // La estructura de la respuesta dependerá de cómo AFIP estructura sus respuestas SOAP
                const parsedResponse = response[0].FEParamGetTiposPaisesResult.ResultGet;
...
exports.FEParamGetTiposPaises = FEParamGetTiposPaises;
